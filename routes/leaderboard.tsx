...
export default function LeaderboardPage({ data }: PageProps<LeaderboardEntry[]>) {
  return (
    <>
      <Head>
      ...
      <div class="min-h-screen bg-gray-900 text-white p-4 py-12">
        <div class="max-w-4xl mx-auto space-y-8">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left">
                        ...
                        <tbody class="divide-y divide-gray-700">
                            {data.map((entry, idx) => (
                                <tr key={entry.userId} class="hover:bg-gray-700/30 transition-colors group">
                                    ...
                                    <td class="px-6 py-4 text-center font-mono text-emerald-400 font-bold">{entry.totalScore}</td>
                                    <td class="px-6 py-4 text-center text-gray-400">{entry.testsTaken}</td>
                                    <td class="px-6 py-4 text-center text-yellow-400 font-bold">{entry.averageScore}</td>
                                </tr>
                            ))}
                            {data.length === 0 && (
                                <tr>
            ...
            <div class="text-center pt-8">
                <a href="/" class="text-gray-400 hover:text-white underline decoration-gray-600 hover:decoration-white transition-all">
                    Back to Home
                </a>
            </div>
        </div>
